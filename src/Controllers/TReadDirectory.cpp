...
namespace fusevfs {
    ...
    void TReadDirectory::DoReadDir(const std::shared_ptr<rwl::TRwLock<TDirectory>>& var) {
        FillerDirectory(var);
    }

    void TReadDirectory::DoReadDir(const std::shared_ptr<rwl::TRwLock<TRegularFile>>& var) {
        throw TFSException(m_pPath, NFSExceptionType::NotDirectory);
    }

    void TReadDirectory::DoReadDir(const std::shared_ptr<rwl::TRwLock<TLink>>& var) {
    ...
    void TReadDirectory::FillerDirectory(const std::shared_ptr<rwl::TRwLock<TDirectory>>& dir) {
