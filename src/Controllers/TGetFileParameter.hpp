...
public:
    ...
    operator()(const CGuardFileObject auto& var) const
    {
        return reinterpret_cast<
            const TFile<TDirectory>*>(var.GetPtr())->m_changed;
    }
    /* write-guard (non-const) */
    std::chrono::system_clock::time_point&
    operator()(CWriteGuardFileObject auto& var) const
    {
        return reinterpret_cast<
            TFile<TDirectory>*>(var.GetPtr())->m_changed;
    }
};
...
public:
    ...
    {
        return reinterpret_cast<
            const TFile<TDirectory>*>(var.GetPtr())->m_modified;
    }
    std::chrono::system_clock::time_point&
    operator()(CWriteGuardFileObject auto& var) const
    {
        return reinterpret_cast<
            TFile<TDirectory>*>(var.GetPtr())->m_modified;
    }
};
...
public:
    ...
    {
        return reinterpret_cast<
            const TFile<TDirectory>*>(var.GetPtr())->m_accessed;
    }
    std::chrono::system_clock::time_point&
    operator()(CWriteGuardFileObject auto& var) const
    {
        return reinterpret_cast<
            TFile<TDirectory>*>(var.GetPtr())->m_accessed;
    }
};
